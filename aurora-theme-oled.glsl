// aurora-theme-oled.glsl - generated from src/aurora.template.glsl.
// Variant: Theme OLED
//
// Ghostty setup:
//   custom-shader = /path/to/ghostty-aurora/aurora-theme-oled.glsl
...
const float TEXT_PROTECT = 0.96;

const int RIBBON_LAYERS = 3;
const int FBM_OCTAVES = 3;
const float CURTAIN_STRENGTH = 0.50;
const float HAZE_STRENGTH = 0.025;
...
const vec3 MORNING_A = vec3(0.36, 0.88, 0.78);
const vec3 MORNING_B = vec3(0.58, 0.50, 0.90);
const vec3 EVENING_A = vec3(0.16, 0.72, 0.62);
const vec3 EVENING_B = vec3(0.32, 0.30, 0.78);
const vec3 NIGHT_A = vec3(0.02, 0.30, 0.26);
const vec3 NIGHT_B = vec3(0.04, 0.06, 0.22);
