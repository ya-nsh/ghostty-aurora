// aurora-arctic.glsl - generated from src/aurora.template.glsl.
// Variant: Arctic
//
// Ghostty setup:
//   custom-shader = /path/to/ghostty-aurora/aurora-arctic.glsl
...
const vec3 EVENING_A = vec3(0.34, 0.98, 0.92);
const vec3 EVENING_B = vec3(0.42, 0.60, 1.00);
const vec3 NIGHT_A = vec3(0.06, 0.48, 0.52);
const vec3 NIGHT_B = vec3(0.08, 0.20, 0.46);
