// aurora-nebula.glsl - generated from src/aurora.template.glsl.
// Variant: Nebula
//
// Ghostty setup:
//   custom-shader = /path/to/ghostty-aurora/aurora-nebula.glsl
...
const float RIBBON_SPEED = 0.038;
const float RIBBON_SCALE = 1.10;
...
const float TEXT_PROTECT = 0.87;

const int RIBBON_LAYERS = 5;
const int FBM_OCTAVES = 4;
const float CURTAIN_STRENGTH = 0.94;
const float HAZE_STRENGTH = 0.085;
const float STAR_INTENSITY = 0.040;
const float NORTH_STAR_INTENSITY = 0.0;

const vec3 MORNING_A = vec3(0.86, 0.72, 1.00);
const vec3 MORNING_B = vec3(1.00, 0.58, 0.76);
const vec3 EVENING_A = vec3(0.66, 0.34, 1.00);
const vec3 EVENING_B = vec3(0.18, 0.62, 1.00);
const vec3 NIGHT_A = vec3(0.18, 0.16, 0.50);
const vec3 NIGHT_B = vec3(0.42, 0.10, 0.54);
