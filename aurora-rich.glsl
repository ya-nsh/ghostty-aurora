// aurora-rich.glsl - generated from src/aurora.template.glsl.
// Variant: Rich
//
// Ghostty setup:
//   custom-shader = /path/to/ghostty-aurora/aurora-rich.glsl
...
const float AURORA_INTENSITY = 0.74;

// Motion and scale of the ribbon field.
const float RIBBON_SPEED = 0.039;
const float RIBBON_SCALE = 1.08;

// Cursor-reactive pulse intensity after typing or cursor movement.
const float CURSOR_REACTIVITY = 0.92;
...
const float TEXT_PROTECT = 0.86;

const int RIBBON_LAYERS = 6;
const int FBM_OCTAVES = 5;
const float CURTAIN_STRENGTH = 0.96;
const float HAZE_STRENGTH = 0.145;
const float STAR_INTENSITY = 0.075;
