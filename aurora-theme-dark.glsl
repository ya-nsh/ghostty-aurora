// aurora-theme-dark.glsl - generated from src/aurora.template.glsl.
// Variant: Theme Dark
//
// Ghostty setup:
//   custom-shader = /path/to/ghostty-aurora/aurora-theme-dark.glsl
...
const float AURORA_INTENSITY = 0.56;
...
const vec3 MORNING_A = vec3(0.62, 0.94, 0.86);
const vec3 MORNING_B = vec3(0.78, 0.58, 0.96);
const vec3 EVENING_A = vec3(0.24, 0.88, 0.68);
const vec3 EVENING_B = vec3(0.42, 0.36, 0.92);
const vec3 NIGHT_A = vec3(0.06, 0.42, 0.36);
const vec3 NIGHT_B = vec3(0.12, 0.12, 0.42);
