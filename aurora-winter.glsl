// aurora-winter.glsl - generated from src/aurora.template.glsl.
// Variant: Winter
//
// Ghostty setup:
//   custom-shader = /path/to/ghostty-aurora/aurora-winter.glsl
...
const float AURORA_INTENSITY = 0.55;

// Motion and scale of the ribbon field.
const float RIBBON_SPEED = 0.027;
const float RIBBON_SCALE = 0.98;
...
const int RIBBON_LAYERS = 4;
const int FBM_OCTAVES = 4;
const float CURTAIN_STRENGTH = 0.74;
const float HAZE_STRENGTH = 0.080;
...
const vec3 MORNING_A = vec3(0.82, 0.98, 1.00);
const vec3 MORNING_B = vec3(0.66, 0.84, 1.00);
const vec3 EVENING_A = vec3(0.32, 0.84, 0.92);
const vec3 EVENING_B = vec3(0.46, 0.52, 0.96);
const vec3 NIGHT_A = vec3(0.06, 0.38, 0.44);
const vec3 NIGHT_B = vec3(0.10, 0.14, 0.40);
