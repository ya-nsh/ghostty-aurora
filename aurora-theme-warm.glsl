// aurora-theme-warm.glsl - generated from src/aurora.template.glsl.
// Variant: Theme Warm
//
// Ghostty setup:
//   custom-shader = /path/to/ghostty-aurora/aurora-theme-warm.glsl
...
const float CURTAIN_STRENGTH = 0.66;
...
const vec3 EVENING_A = vec3(0.48, 0.78, 0.48);
const vec3 EVENING_B = vec3(0.80, 0.36, 0.62);
const vec3 NIGHT_A = vec3(0.12, 0.36, 0.28);
const vec3 NIGHT_B = vec3(0.30, 0.10, 0.28);
