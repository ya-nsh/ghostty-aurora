// aurora-minimal.glsl - generated from src/aurora.template.glsl.
// Variant: Minimal
//
// Ghostty setup:
//   custom-shader = /path/to/ghostty-aurora/aurora-minimal.glsl
...
const float AURORA_INTENSITY = 0.32;

// Motion and scale of the ribbon field.
const float RIBBON_SPEED = 0.022;
const float RIBBON_SCALE = 0.86;
...
const float CURTAIN_STRENGTH = 0.42;
const float HAZE_STRENGTH = 0.020;
