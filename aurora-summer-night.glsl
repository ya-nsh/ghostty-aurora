// aurora-summer-night.glsl - generated from src/aurora.template.glsl.
// Variant: Summer Night
//
// Ghostty setup:
//   custom-shader = /path/to/ghostty-aurora/aurora-summer-night.glsl
...
const float AURORA_INTENSITY = 0.60;

// Motion and scale of the ribbon field.
const float RIBBON_SPEED = 0.032;
const float RIBBON_SCALE = 1.04;
...
const float CURTAIN_STRENGTH = 0.82;
const float HAZE_STRENGTH = 0.105;
const float STAR_INTENSITY = 0.030;
...
const vec3 MORNING_A = vec3(0.68, 0.96, 0.84);
const vec3 MORNING_B = vec3(1.00, 0.70, 0.40);
const vec3 EVENING_A = vec3(0.32, 0.92, 0.70);
const vec3 EVENING_B = vec3(0.26, 0.50, 0.96);
const vec3 NIGHT_A = vec3(0.04, 0.44, 0.38);
const vec3 NIGHT_B = vec3(0.06, 0.20, 0.46);
