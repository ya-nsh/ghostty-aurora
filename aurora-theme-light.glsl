// aurora-theme-light.glsl - generated from src/aurora.template.glsl.
// Variant: Theme Light
//
// Ghostty setup:
//   custom-shader = /path/to/ghostty-aurora/aurora-theme-light.glsl
...
const float AURORA_INTENSITY = 0.24;

// Motion and scale of the ribbon field.
const float RIBBON_SPEED = 0.018;
const float RIBBON_SCALE = 0.88;
...
const float TEXT_PROTECT = 0.98;

const int RIBBON_LAYERS = 2;
const int FBM_OCTAVES = 3;
const float CURTAIN_STRENGTH = 0.38;
const float HAZE_STRENGTH = 0.010;
...
const vec3 MORNING_A = vec3(0.30, 0.68, 0.62);
const vec3 MORNING_B = vec3(0.62, 0.38, 0.72);
const vec3 EVENING_A = vec3(0.14, 0.58, 0.48);
const vec3 EVENING_B = vec3(0.34, 0.26, 0.70);
const vec3 NIGHT_A = vec3(0.06, 0.34, 0.30);
const vec3 NIGHT_B = vec3(0.12, 0.10, 0.36);
