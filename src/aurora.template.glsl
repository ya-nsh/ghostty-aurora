...
const float TYPING_WAKE_ENABLED = @TYPING_WAKE_ENABLED@;
const float TYPING_WAKE_AMOUNT = @TYPING_WAKE_AMOUNT@;
const float TYPING_WAKE_DURATION = @TYPING_WAKE_DURATION@;
const float TYPING_WAKE_SPEED_BOOST = @TYPING_WAKE_SPEED_BOOST@;
