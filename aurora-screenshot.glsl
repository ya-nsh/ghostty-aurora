// aurora-screenshot.glsl - generated from src/aurora.template.glsl.
// Variant: Screenshot
//
// Ghostty setup:
//   custom-shader = /path/to/ghostty-aurora/aurora-screenshot.glsl
...
const float AURORA_INTENSITY = 0.86;

// Motion and scale of the ribbon field.
const float RIBBON_SPEED = 0.036;
const float RIBBON_SCALE = 1.14;
...
const float TEXT_PROTECT = 0.84;

const int RIBBON_LAYERS = 6;
const int FBM_OCTAVES = 5;
const float CURTAIN_STRENGTH = 1.08;
const float HAZE_STRENGTH = 0.170;
const float STAR_INTENSITY = 0.060;
