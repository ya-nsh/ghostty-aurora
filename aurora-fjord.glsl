// aurora-fjord.glsl - generated from src/aurora.template.glsl.
// Variant: Fjord
//
// Ghostty setup:
//   custom-shader = /path/to/ghostty-aurora/aurora-fjord.glsl
...
const float AURORA_INTENSITY = 0.52;

// Motion and scale of the ribbon field.
const float RIBBON_SPEED = 0.026;
const float RIBBON_SCALE = 0.96;
...
const float CURTAIN_STRENGTH = 0.72;
...
const vec3 MORNING_A = vec3(0.58, 0.96, 0.82);
const vec3 MORNING_B = vec3(0.62, 0.76, 1.00);
const vec3 EVENING_A = vec3(0.20, 0.78, 0.62);
const vec3 EVENING_B = vec3(0.18, 0.48, 0.82);
const vec3 NIGHT_A = vec3(0.06, 0.36, 0.34);
const vec3 NIGHT_B = vec3(0.08, 0.18, 0.36);
