// aurora-theme-transparent.glsl - generated from src/aurora.template.glsl.
// Variant: Theme Transparent
//
// Ghostty setup:
//   custom-shader = /path/to/ghostty-aurora/aurora-theme-transparent.glsl
...
const float RIBBON_SPEED = 0.024;
const float RIBBON_SCALE = 0.94;
...
const float CURTAIN_STRENGTH = 0.54;
const float HAZE_STRENGTH = 0.018;
const float STAR_INTENSITY = 0.0;
const float NORTH_STAR_INTENSITY = 0.0;

const vec3 MORNING_A = vec3(0.52, 0.90, 0.86);
const vec3 MORNING_B = vec3(0.66, 0.62, 0.96);
const vec3 EVENING_A = vec3(0.20, 0.72, 0.64);
const vec3 EVENING_B = vec3(0.32, 0.42, 0.88);
const vec3 NIGHT_A = vec3(0.04, 0.34, 0.32);
const vec3 NIGHT_B = vec3(0.08, 0.12, 0.34);
