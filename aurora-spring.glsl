// aurora-spring.glsl - generated from src/aurora.template.glsl.
// Variant: Spring
//
// Ghostty setup:
//   custom-shader = /path/to/ghostty-aurora/aurora-spring.glsl
...
const vec3 MORNING_A = vec3(0.74, 1.00, 0.76);
const vec3 MORNING_B = vec3(1.00, 0.68, 0.70);
const vec3 EVENING_A = vec3(0.34, 0.94, 0.58);
const vec3 EVENING_B = vec3(0.66, 0.44, 0.94);
const vec3 NIGHT_A = vec3(0.08, 0.46, 0.34);
const vec3 NIGHT_B = vec3(0.18, 0.16, 0.42);
